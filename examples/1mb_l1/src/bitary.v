...
// way of that pair.
//
//     access to way0 means of that of way1 and way0, way1 one is now least
//     recently used.
//
...
//
// You can reason then that accessing a pair of ways should not change 
...
//    w3  w2  w1  w0      WAY labels, w0 -> way0
//
// LRU victim, assuming all ways are valid, {b2,b1,b0};
//
...
// 1x1  | 1111       | way 0
//
// Victim selection due to invalid, left most invalid is selected. LRU is
// dont care if there are invalid ways
//
// LRU  | valid bits | victim
// -----|------------|--------
// ???  | 0---       | way 3 
// ???  | 10--       | way 2
// ???  | 110-       | way 1
